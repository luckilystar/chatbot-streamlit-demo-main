...
if ("agent" not in st.session_state) or (getattr(st.session_state, "_last_key", None) != google_api_key):
    try:
        ...
        st.session_state.agent = create_react_agent(
            ...
            Answer the user's question based on the language used in the question.

            If you encounter a question that cannot be answered with the sales data or doesn't related with the sales data, politely inform the user that you can only answer questions related to sales data.
